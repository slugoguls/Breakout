...
void Game::Init()
{
    ...
    // load textures
    ResourceManager::LoadTexture(RESOURCES_PATH"background.jpg", false, "background");
    ResourceManager::LoadTexture(RESOURCES_PATH"awesomeface.png", true, "face");
    ResourceManager::LoadTexture(RESOURCES_PATH"block.png", false, "block");
    ResourceManager::LoadTexture(RESOURCES_PATH"block_solid.png", false, "block_solid");
    ResourceManager::LoadTexture(RESOURCES_PATH"paddle.png", true, "paddle");
    ResourceManager::LoadTexture(RESOURCES_PATH"particle.png", true, "particle");
